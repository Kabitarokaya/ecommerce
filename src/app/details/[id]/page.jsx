...
function page() {
  let { id } = useParams()
  // let { state, dispatch } = useContext(CartProvider)
        ...
        <div className="grid items-start grid-cols-1 lg:grid-cols-3">
          <div className="col-span-2 grid grid-cols-2 lg:sticky top-0 gap-0.5">
            <div className="columns-2 gap-0.5 space-y-0.5">
              <div className="overflow-hidden border border-gray-500 m-3">
                <img src={data.thumbnail} alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[2] transition-all duration-300" />
              </div>
              <div className="overflow-hidden border-gray-500 m-3 border">
                <img src={data.thumbnail} alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md " />
              </div>
              <div className="overflow-hidden border border-gray-500 m-3">
                <img src={data.thumbnail} alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md " />
              </div>
            ...
            <div className="overflow-hidden border border-gray-500 m-3">
              <img src={data.thumbnail} alt="Product" className="w-full aspect-[3/4] object-cover object-top shadow-md " />
            </div>
          </div>
          <div className="py-6 px-8 max-lg:max-w-2xl">
            ...
            <div className="flex items-center space-x-1 mt-6">
              <svg className="w-4 h-4 fill-slate-800" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-8">
              <div className="flex items-center flex-wrap gap-4">
                <p className="text-slate-900 text-4xl font-semibold">${data.price}</p>
                <p className="text-slate-400 text-sm mt-2"><strike>$42</strike> <span className="ml-1">Tax included</span></p>
              </div>
            </div>

            <div className="mt-8 space-y-4">
              <button type="button" className="w-full px-4 py-2.5 cursor-pointer border border-slate-800 bg-orange-600  text-slate-900 text-sm font-medium rounded-md" onClick={() => dispatch({ type: "addtocart", payload: a })}>Add to cart</button>

            </div>
            <div className="mt-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-900">Product Description</h3>
                <p className="text-sm text-slate-500 mt-4">{data.description}</p>
              </div>
